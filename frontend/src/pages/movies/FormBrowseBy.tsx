...
const FormBrowseBy = ({ selectedDecade, selectedRating, selectedPopular, selectedGenre }: FormBrowseByProps) => {
    ...
    return (
        <form className={styles.formBrowseBy}>
            ...
            <select name="YEAR" value={selectedDecade || ''} onChange={(e) => handleChange(e, 'decade')}>
            ...
            <select name="rating" value={selectedRating || ''} onChange={(e) => handleChange(e, 'rating')}>
            ...
            <select name="popular" value={selectedPopular || ''} onChange={(e) => handleChange(e, 'popular')}>
