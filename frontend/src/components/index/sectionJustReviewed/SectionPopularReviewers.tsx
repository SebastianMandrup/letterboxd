      ...
      {popularReviewers.map((reviewer, index) => {
        return (
          <article key={index} className={styles.articlePopularReviewer}>
            <img
              className={styles.imgReviewerAvatar}
              src={reviewer.srcAvatar}
              alt="Reviewer Avatar"
            />
            <section>
              <p className={styles.pReviewerName}>{reviewer.name}</p>
              <p className={styles.pReviewerStats}>
                {reviewer.numberOfFilms} films, {reviewer.numberOfReviews}{' '}
                reviews
              </p>
            </section>
          </article>
