  ...
  return (
    <section>
      ...
      <div className={styles.divLetterboxLetsYouButtons}>
        ...
        <ButtonLetterboxLetsYou
          svg={heartSvg}
          text="Discover new movies and find out what your friends are watching and loving."
        />
        <ButtonLetterboxLetsYou
          svg={editSvg}
          text="Write reviews and share your opinions with a community of film lovers."
        />
        <ButtonLetterboxLetsYou
          svg={starSvg}
          text="Rate and review films to build a personal record of your film-watching journey."
        />
        <ButtonLetterboxLetsYou
          svg={diarySvg}
