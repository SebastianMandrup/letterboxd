...
describe('getApiAvatar', () => {
    const defaultAvatar = 'https://ui-avatars.com/api/?name=muo&background=random';
    ...
    it('replaces username with pass value', () => {
        ...
        expect(getApiAvatar(username)).toBe('https://ui-avatars.com/api/?name=john%20doe&background=random');
    });
});
