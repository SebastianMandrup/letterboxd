...
describe('validateMovieTitle', () => {
    ...
    it('throws if title is empty', () => {
        expect(() => validateMovieTitle('')).toThrow('Movie title is required and must be a string.');
    });

    it('throws if title is not a string', () => {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        expect(() => validateMovieTitle(null as any)).toThrow('Movie title is required and must be a string.');
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        expect(() => validateMovieTitle(undefined as any)).toThrow('Movie title is required and must be a string.');
    });
