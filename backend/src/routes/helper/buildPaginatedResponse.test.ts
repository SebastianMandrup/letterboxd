...
describe('buildPaginatedResponse', () => {
    ...
    it('should return correct pagination for default page and pageSize', () => {
        ...
        expect(result.next).toBe('http://localhost:3000/api/users/?page=2&pageSize=40');
    ...
    it('should respect query.page and query.pageSize', () => {
        ...
        expect(result.next).toBe('http://localhost:3000/api/users/?page=3&pageSize=20');
        expect(result.previous).toBe('http://localhost:3000/api/users/?page=1&pageSize=20');
    });
    ...
    it('should return null for next if on the last page', () => {
        ...
        expect(result.previous).toBe('http://localhost:3000/api/users/?page=2&pageSize=20');
    });
    ...
    it('should return null for previous if on the first page', () => {
        ...
        expect(result.previous).toBeNull();
        expect(result.next).toBe('http://localhost:3000/api/users/?page=2&pageSize=20');
    });
});
